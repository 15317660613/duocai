<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag :title="'客源历史跟进 【'+titlename+'】'" width="500px" @close="clearFormData" :visible.sync="dialogHistoryFollow" :append-to-body='true' >
      <div class="pop-up" >
            ...
            <div    class="clear" >
              <div class="followList" style="height:257px;overflow:auto;" >
                <div v-for="item in processings" :class="{'elemFollow':true,'clear':true,'click-check':item.id == followId,}" @click="getFollowId(item.id)" >
                  <div class="left" style="width:245px;padding-left:5px;"  >
