<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="选定客改自定号" width="350px" @close="clearFormData" :visible.sync="dialogModifyNum" :append-to-body="true" >
      <div class="pop-up" >
...
<script>
  ...
  import {modifyNum} from "../../../service/houseData";
  export default {
