<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="修改房号" width="610px" :visible.sync="dialogEditorHouseNum" :append-to-body="true" >
      <div class="pop-up" >
        ...
        <div slot="footer" class="dialog-footer clear">
          <span class="right save-cancel-btn"  @click="dialogEditorHouseNum = false">取 消</span>
...
<script>
  import {editorHouseNum,modifyHouseNum}  from '../../../service/getData'
  export default {
    props:["editorHouseNumValue"],
    data() {
      return {
        dialogEditorHouseNum:this.editorHouseNumValue,
        villages:[],
        seats:[],
        units:[],
        orientationParams:[],
    ...
    methods:{
      ...
      editorHouseNum(obj,id){
        let _this =this;
        _this.dialogEditorHouseNum = true;
        _this.dialogNewHouseNum = true;
        _this.form.villageName = obj.villageName;
        _this.form.villageSeatName = obj.seatName;
        _this.form.villageUnitName = obj.unitName;
        _this.form.villageUnitId = obj.unit;
        _this.form.villageId = obj.villageId;
        _this.form.villageSeatId = obj.villageSeatId;
        editorHouseNum(id).then(function(response) {
      ...
      clearFormData(){
        ...
        this.dialogEditorHouseNum = false
      },
    }
  }
</script>
