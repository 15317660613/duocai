<template>
  <div class="" >
    <el-dialog v-dialogDrag title="删除栋座" :close-on-click-modal="false" width="350px" :visible.sync="dialogDeletePedestal" :append-to-body="true" >
      <div class="pop-up" >
...
<script>
  import {deletedPedestal} from '../../../service/getData'
  export default {
