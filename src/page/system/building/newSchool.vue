<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag  title="楼盘-学校" width="350px" :visible.sync="dialogNewSchool" @close="clearFormData" :append-to-body="true" >
      <div class="pop-up" >
...
<script>
  ...
  export default {
    ...
    methods:{
      newSchool(form,type,ss){
        this.panduan=ss
        this.dialogNewSchool = true;
        this.getNearbySelect(form,type);
      },
      getNearbySelect(form,type){
        let _this =  this;
        let id = '';
        let schoolId = '';
        let villageId = '';
