<template>
  <div class="" >
    <el-dialog v-dialogDrag :close-on-click-modal="false" title="加入 【单栋】" width="350px" :visible.sync="dialogSingPedestal" append-to-body="true" >
      <div class="pop-up" >
...
<script>
  import {newPedestal} from '../../../service/getData'
  export default {
