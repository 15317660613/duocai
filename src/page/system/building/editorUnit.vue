<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="修改单元" width="550px" :visible.sync="dialogVisible" @close="clearFormData" :append-to-body="true" >
      <div class="pop-up" >
...
<script>
  ...
  import {editorUnit,modifyUnit}  from '../../../service/getData'
  export default {
