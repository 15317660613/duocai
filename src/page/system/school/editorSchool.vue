<template>
    <!-- <el-dialog v-dialogDrag :title="'学校修改 【'+titlename+'】'" width="500px" :visible.sync="dialogEditorSchool" :append-to-body="true" > -->
    <div style="width:100%;padding:0 10px;">
      <div class="pop-up" style="">
        <div class="pop-up-container" style="height:290px;border: none;" >
          <el-tabs type="border-card" v-model="getActiveName" >
            <el-tab-pane label="学校详情" name="school" >
              <span slot="label">学校详情</span>
              <div class="" >
                <div class="pop-up-container" style="height:236px;" >
                      ...
                      <div class="clear" >
                        ...
                        <div class="left" >
                          <el-form-item prop="name">
                            <el-input v-model="form.name" maxlength="20" title="上限20个字" autocomplete="off" style="width:290px" ></el-input>
                          </el-form-item>
                        </div>
                      ...
                      <div class="clear" >
                        ...
                        <div class="left" >
                          <el-form-item prop="adress" >
                            <el-input v-model="form.adress" maxlength="80" title="上限80个字" autocomplete="off" style="width:220px" ></el-input>
                          </el-form-item>
                        </div>
                      </div>
                      <div class="clear" >
                        ...
                        <div class="left" style="padding-top:5px;" >
                          <el-form-item label="学校介绍" label-width="68px"  prop="introduce">
                            <el-input
                              ...
                              class=""
                              :rows="6"
                              style="width:290px;border-width:0;"
            ...
            <el-tab-pane label="附近楼盘" name="building"  >
              ...
              <div class="" >
                <div class="pop-up-container clear" style="height: 236px;">
                ...
                <div slot="footer" class="dialog-footer clear" style="width:100%;padding: 3px 0px;">
                  <span class="right save-cancel-btn" @click="cancelData">取 消</span>
                  <span class="right save-cancel-btn" type="primary" @click="saveData">保 存</span>
                </div>
                <div class="component-container" >
                  <NewSchoolPage @reloadSchoolList="reloadSchoolList" :newSchoolValue="newNearbySchool" ref="showNewSchool"></NewSchoolPage>
                </div>
                <div class="component-container" >
                  <EditorSchoolPage :editorSchoolValue="editorNearbySchool" ref="showEditorSchool"></EditorSchoolPage>
                </div>
                <div class="component-container" >
                  <EditorBuildingPageSpecial  @reloadList="reloadSchoolList" :buildingShowEditor="buildingShowEdiotrValue"  ref="editorBuilding" ></EditorBuildingPageSpecial>
                </div>
...
<script>
  ...
  //附近学校组件
  import NewSchoolPage from '../building/newSchool'
  import EditorSchoolPage from '../building/editorSchool'
  // 编辑楼盘字段
  import EditorBuildingPageSpecial from '../building/editorBuilding'
  export default {
    props:["myid","editorSchoolValue",'activeName',"myname","layerid"],
    data() {
      return {
    ...
    methods:{
      ...
      showEditorBuilding(index, row){
        ...
        let layerId = this.$layer.iframe({
          content: {
            content: EditorBuildingPageSpecial, //传递的组件对象
            parent: this,//当前的vue对象
            data:{areaVillageId:row.id,areaVillage:row.name,thistrue:false,tabactive:'building',currentIndex:index}//props
          },
          type:2,
          area:['600px','680px'],
          title: '楼盘修改 【'+row.name+'】',
    ...
    mounted(){
      this.getEditorSchool(this.getId,this.myname)
    },
  }
</script>
