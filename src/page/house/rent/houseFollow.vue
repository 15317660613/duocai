<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag :title="'房源全部跟进 【'+houseName+'】'" width="500px" @close="clearFormData" :visible.sync="dialogHistoryFollow" :append-to-body='true' >
      <div class="pop-up" >
        <div class="pop-up-container " style="height: 262px;">
          <div class="move-content" >
            <div    class="clear" >
              <div class="followList" style="height:258px;overflow:auto;" >
                <div style="width:445px;" v-for="item in processings" :class="{'elemFollow':true,'clear':true,'click-check':item.id == followId,}" @click="getFollowId(item.id)" >
                  <div class="left overflowEellipsis" style="width:285px;height:18px;padding-left:5px;"  >
