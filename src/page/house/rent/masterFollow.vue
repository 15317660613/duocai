<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag :title="'查看业主操作日志【最近三天】【'+houseName+'】'" width="500px" @close="clearFormData" :visible.sync="dialogHistoryFollow" :append-to-body='true' >
      <div class="pop-up" >
        <div class="pop-up-container " style="height: 262px;">
          <div class="move-content" >
            <div    class="clear" >
              <div class="followList" style="height:250px;overflow:auto;" >
