<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="修改进程状态" width="350px" height="250px" @close="clearFormData" :visible.sync="dialogModifyProgress" :append-to-body='true' >
      <div class="pop-up" >
