      ...
      <div class="search-container mycontailerclass2">
        <div class="clear" >
          ...
          <div class="item left clear" >
            <i class="back-icon user left" @click="tabRemove('/home/rent')" ></i>
          </div>
          <div class="left padding-l-5"  >
            <i class="cut-icon"></i>
          </div>
        ...
        <el-form ref="formsData"  :model="form" >
          <div class="clear" style="margin-top: 5px;margin-bottom: 5px;">
            ...
            <div class="left " style="padding-left:30px;" >
              <el-form-item label="" label-width="0">
                <el-input v-model.trim="form.word" maxlength="30" title="房源编号, 楼盘位置房号" style="width:145px;"  autocomplete="off" ></el-input>
              </el-form-item>
            </div>
    ...
    <div class="content clear" >
      ...
      <div class="list-content" >
        ...
        >
              ...
              <template  slot-scope="scope">
                <div style="">
                  <div class="" style="width:120px;text-align:center;" >
                    <i class="house-list-icon" ></i>
                  </div>
                  <div style="width:120px;line-height:18px;text-align:center;padding-bottom:20px;" >
          ...
          >
            <template  slot-scope="scope">
              <div class="clear" style="height:110px;">
                <div  v-for="(item , index) in scope.row.buyList" class="left" style="width:135px;height:110px;border-right:1px solid #fff;position:relative;" >
                  <div v-if="item.name" class="clear" >
                    ...
                    <div class="clear" style="padding-top:3px;" >
                      <div @click="modifyProgressElem(item.id)" class="left" style="cursor:pointer;padding-left:30px;font-size:14px;line-height:18px;height:18px;font-weight:700" >
                        {{item.processingStateId}}
                      </div>
                      <div class="left" @click="editorCustomer(scope.$index, item)" style="cursor:pointer;color:#336699;font-weight:700;background:#fff;line-height:18px;height:18px;width:50px;text-align:center;border-radius:3px;" >
                        {{item.name}}
                      </div>
                      <div class="left" >
                  ...
                  <div v-else="item.num" class="left" style="width:135px;height:110px;border-right:1px solid #fff;" >

                  </div>

                </div>
                <div class="left clear " style="width:120px;height:110px;" >
                  <div class="left" >
                    <div class="clear" style="height:110px;width:80px" >
                  ...
                  <div class="left" style="height:110px;width:40px;" >
...
<script>
  ...
  * */
  ...
  import ModifyProgressPage from './modifyProgressSpecial'
    ...
    methods: {
      ...
      editorRent(index, row){
        ...
        let test = _this.$layer.iframe({
          content: {
            ...
            data:{id:row.id,address:row.houseAddress,activeName:'house',ids:ids.toString(),currentIndex:index}//props
          },
          area:['800px','560px'],
          title:"房源信息 【"+ this.currentPage.houseAddress.replace("<br/>","")+"】",
          shadeClose: false,
          shade: false,//是否显示遮罩
          zIndex:3000, //层优先级
          cancel:()=>{//关闭事件
        ...
        if(id){
          departperson(id).then(function (response) {
            if (response.status == 500) {
              ...
              let data = response.data;
              let user = data.user;let arr = [{id:'-1',name:"全部",select:true}];
      ...
      moreCompareClick(index,row){
        ...
        let test = _this.$layer.iframe({
          content: {
            content: EditorRentPage, //传递的组件对象
            parent: this,//当前的vue对象
            data:{id:row.id,address:row.houseAddress,activeName:'pedestal',ids:ids.toString(),currentIndex:index}//props
          },
          area:['800px','560px'],
          title:"房源信息 【"+ this.currentPage.houseAddress.replace("<br/>","")+"】",
          shadeClose: false,
      ...
      editorCustomer(index, row){
        ...
        _this.$layer.iframe({
          ...
          area:['812px','550px'],
          title:"客源信息 【"+ this.currentPage.houseAddress.replace("<br/>","")+"】",
          shadeClose: false,
          shade: false,//是否显示遮罩
          zIndex:3000, //层优先级
          cancel:()=>{//关闭事件
