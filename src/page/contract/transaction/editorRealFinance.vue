  ...
  <div class="" style="width:100%;padding:0 10px;" >
      ...
      <div class="pop-up" style="margin-bottom: 10px;">
                ...
                <div class="clear" style="" >
                  ...
                  <div class="left">
                    <el-form-item   prop="businessType1" >
                      <el-select :disabled="finishDisabled || salaryAndFinanceDisabled ||hasAccountDisabled" @change="getChildrenParamsList" v-model="form.businessType1"  placeholder="" style="width:105px;" >
                  ...
                  <div class="left">
                    <el-form-item  prop="businessType2" >
                      <el-select  @change="setDisabled"  :disabled="finishDisabled || salaryAndFinanceDisabled || hasAccountDisabled" v-model="form.businessType2"  placeholder="" style="width:120px;" >
                ...
                <div class="clear" >
                  ...
                  <div class="left">
                    <el-form-item  prop="sourceGetId" >
                      <el-select   :disabled="finishDisabled || disabledTyp1 || salaryAndFinanceDisabled || hasAccountDisabled"  v-model="form.sourceGetId"  placeholder="" style="width:80px;" >
                  ...
                  <div class="left">
                    <el-form-item  prop="sourceGetName" >
                      <el-input :disabled="finishDisabled || disabledTyp1 || salaryAndFinanceDisabled || hasAccountDisabled" title="上限10个字" maxlength="10"  v-model="form.sourceGetName" style="width:90px;" ></el-input>

                    </el-form-item>
                  </div>
                  <div class="left text-input" style="position:relative;" >
                    <el-form-item  prop="sourceGetAmount" >
                      <el-input :disabled="finishDisabled || disabledTyp1 || salaryAndFinanceDisabled || hasAccountDisabled" @input="checkNum1" title="上限10个字" maxlength="13" v-model="form.sourceGetAmount" style="width:80px;" ></el-input>

                    </el-form-item>
                    <i v-if="accountIcon1"  :class="{'seven-one-icon':beAccount == 3,'seven-two-icon':beAccount == 2,'seven-three-icon':beAccount == 4}"  @click="clickShowBeAccount" style="position:absolute;top:5px;left:1px;" ></i>
                  </div>
                  <div class="left">
        ...
        <div slot="footer" style="padding:5px 0;" class="dialog-footer clear">
          <div v-if="salaryAndFinanceDisabled1 &&  form.isAchievement == 1" class="left close-word" >
            此财务关联的同项类业绩分成已结算，工资已封账，不允许修改！
          </div> 
          <div v-else-if="salaryAndFinanceDisabled2 &&  !form.isAchievement == 1" class="left close-word" >
            此财务关联的收支已封账，不允许修改！
           </div> 
           <div v-else-if="hasAccountDisabled " class="left close-word" >
            该笔财务已被平账，【业类/金额/收支对方】不可修改
           </div>
...
<script>
  ...
  export default {
    props:[ "contractId", "businessType","contractCode","roomAddress","financeId","finishDisabled","layerid"],
    data() {
      return {
        ...
        disabledTyp1:false,
        disabledTyp2:false,
        salaryAndFinanceDisabled:false, // 工资封账
        salaryAndFinanceDisabled1:false,//此财务关联的同项类业绩分成已结算，工资已封账，不允许修改！
        salaryAndFinanceDisabled2:false,//  此财务关联的收支已封账，不允许修改！
        hasAccountDisabled:false, // 平账禁用  该笔财务已被平账，【业类/金额/收支对方】不可修改
        isAchievementDisabled:false,// 计业绩 业类 x ,X 禁用
        processWayIdParams:[],
        sourceGetTypeParams:[],
        sourceGetBankParams:[],
        sourceGetIdParams1:[],
    ...
    methods:{
      ...
      setDisabled(){
        ...
        if(name && (name.indexOf("X") != -1 && name2.indexOf("1") != -1 )) {
          ...
          this.form.targetPayAmount = '0.00';
           _this.accountIcon1 = true;
        }else{
          this.disabledTyp2 = false;
          this.accountIcon1 = false;
      ...
      getFinanceParamData(businessType,financeId){
        let _this = this;
        this.$layer.loading({
          shade: true,//是否显示遮罩
        })
        ...
        editorContractFinance(form).then(function(response) {
          ...
          if (response.status == 500) {
            ...
            businessType1Params.forEach(item =>{
              ...
              if(item.id == financeData.businessType1){
                businessName = item.name;
              }  
            })
            _this.businessType1Params = businessType1Params;

            if(businessName && businessName.indexOf("X") != -1){
              let over = financeData.over;
              let sourceGetAmount = financeData.sourceGetAmount;
              over = Number(over);
              sourceGetAmount = Number(sourceGetAmount);

              
              if(over != NaN && sourceGetAmount != NaN){
                if(over == sourceGetAmount ){
                  _this.beAccount = 3;
                  _this.hasAccountDisabled = false;
                }else if(over == 0 && sourceGetAmount != 0){
                  _this.beAccount = 2;
                  _this.hasAccountDisabled = true;
            ...
            if(isClosingAccounts == '1'){
              ...
              if(financeData.isAchievement == 1){
    ...
    mounted(){
      ...
      this.getFinanceParamData(this.businessType,this.financeId);
    },
    watch:{
