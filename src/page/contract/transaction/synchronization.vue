<template>
  <div class="" style="margin:0 10px;width:100%;">
    ...
    <div class="pop-up" style="width:100%;padding:6px 0 0;">
        <div class="search-container" style="height:405px;margin:0 10px;overflow:auto;" >
            ...
            <div
                ...
                style="height:370px;overflow:auto;width:190px;margin:0;border-left:none;border-bottom:none;"
            >
                <el-tree
                :data="treeData"
                show-checkbox
            ...
            <div class="left content">
                <div class="break"></div>
                <div style="widht:100%;height:295px;overflow:auto;" class="clear">
...
<script>
import {findUpDepartByDepartId,departperson,findUserByDepartId} from "../../../service/organizeDate";
...
export default {
  ...
  methods: {
    ...
    getTreeDateDepart(){
      ...
      let form = {userId:this.userId,word:word};
    ...
    getUserData(){
      ...
      let form = {id:getChiefDepartIds,flag:3,isSelect:1,showLeave:1,doBusiness:1};
    ...
    gettreeData(arg1,arg2){
      ...
      if(str){
        if(str.indexOf(id) != -1){
          let form = {id,flag:3,isSelect:1,showLeave:1,doBusiness:1};
          findUserByDepartId(form).then( (response)=> {
            this.$layer.closeAll("loading");
            if (response.status == 500) {
              return false;
            } else if (response.status == 0) {
