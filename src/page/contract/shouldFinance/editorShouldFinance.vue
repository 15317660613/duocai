                ...
                <div class="clear" >
                  ...
                  <div class="left text-input">
                    <el-form-item  prop="sourceGetAmount" >
                      <el-input :disabled="finishDisabled  || salaryAndFinanceDisabled" title="上限10位数" maxlength="13" @input="checkNum1" v-model="form.sourceGetAmount" style="width:70px;" ></el-input>
...
<script>
  ...
  export default {
    props:["contractId","businessType","id","currentIndex","layerid"],
    data() {
      return {
