    ...
    <div class="pop-up" style="width:100%;padding:6px 0 0;">
        <div class="search-container" style="height:468px;margin:0 10px;overflow:auto;" >
            ...
            <div class="clear">
                ...
                <el-input v-model="departName" @input="querySearchAsync" maxlength="10" title="部门名称" style="width:130px;"></el-input>
                </div>
            ...
            <div class="left content">
                <div class="break"></div>
                <div style="widht:100%;height:353px;overflow:auto;" class="clear">
                ...
                <p  ><div style="width: 12px;height: 12px;background: rgba(0, 204, 102, 1);margin-right: 5px;display: inline-block;"></div>该月已生成提金</p>
