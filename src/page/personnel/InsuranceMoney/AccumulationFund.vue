        ...
        <div class="clear" >
          <label>
            <div class="left padding-l-15"  >
              <el-radio @change="changeToInsuranceMoney" v-model="IMorAF" :label="1">&nbsp;</el-radio>
            </div>
            <div class="left" >
              保险
            </div>
          ...
          <label>
            <div class="left padding-l-10" >
              <el-radio  v-model="IMorAF" :label="2">&nbsp;</el-radio>
            </div>
            <div class="left" >
              公积金
            </div>
          ...
          <div class="item left padding-l-10 clear"  @click="addAccumulationFund" >
            <div class="left"  >
          ...
          <div class="item left clear padding-l-10" @click="deletedAccumulationFund">
            <div class="left"  >
          ...
          <div class="clear">
            ...
            <div class="left " style="padding-left:15px;"  >
              <el-form-item prop="word" label-width="0">
                <el-input v-model.trim="form.word" title="姓名/个人代码/备注"  maxlength="30" style="width:100px;"  autocomplete="off" ></el-input>
              </el-form-item>
            </div>
      ...
      <div class="list-content">
        ...
        >
          <template v-if="item.show" v-for="(item,index) in columnData" >
            ...
            >
              ...
              <template slot-scope="scope" style="height: 100%;">
                <div style="position: absolute;top: 50%;margin-top: -6px;width: 100%;">
                  <div class="findparentclass" style="color:#336699;text-algin:center;cursor:pointer;z-index: 333;font-weight: bold;" @click="editorAFPersonMonth(scope.$index, scope.row)" >
                    {{ scope.row.user }}
                  </div>
                  <!-- 状态 -->
            ...
            <PlTableColumn
              v-else-if="item.prop == 'priceCom'||item.prop == 'pricePer'"
              :prop="item.prop"
              :label="item.label"
              :width="item.width"
              :type="item.type"
...
<script>
  ...
  import newAddInsurancepage from './newAddInsurance'
  import EditorAFPersonMonthPage from './editorAFPersonMonth'
  ...
  export default {
    data() {
      return {
        ...
        rowHeight:37,
        culumnTitle:'公积金明细',
        sessionStr:'AccumulationFund-list',
        tableData:[],
        columnData:InsuranceMoneyParam.AccumulationFundColumn,
        currentPage:'',
        multipleSelection:[],
        userParams:[],
    ...
    methods:{
      ...
      changeToInsuranceMoney(){
        this.$router.push('/home/InsuranceMoney');
      },
      selectChangemethods(){
        ...
        InsuranceMoneyParams().then(function(response){
          ...
          if (response.status == 500) {
            ...
            if(data.paramIdParams){
              let initArr = [{id:"-1",name:"全部",select:true}];
              _this.insuranceMoneyuseParams = initArr.concat(data.paramIdParams);
        ...
        InsuranceMoney(form).then(function(response){
          ...
          if (response.status == 500) {
            ...
            if(data.list.length!=0){
              let columnDatatotal = {
                num2total:data.total.priceCom,
                num3total:data.total.pricePer,
              };
      ...
      addAccumulationFund(){
        ...
        let layerId = _this.$layer.iframe({
          content: {
            content: newAddInsurancepage, //传递的组件对象
            parent: this,//当前的vue对象
            data:{mytype:'公积金'}//props
          },
          area:['800px','560px'],
          title: "批量新增公积金人月",
          shadeClose: false,
      ...
      editorAFPersonMonth(index, row){
        ...
        let layerId = _this.$layer.iframe({
          content: {
            content: EditorAFPersonMonthPage, //传递的组件对象
            parent: this,//当前的vue对象
            data:{myid:row.id,mythisindex:index}//props
          },
          area:['500px','350px'],
          title:"公积金修改 【" + row.user + '&nbsp;&nbsp;&nbsp;&nbsp;' + row.time + "】",
          shadeClose: false,
          shade: false,//是否显示遮罩
          zIndex:19891110,
          cancel:()=>{//关闭事件
      ...
      //删除项目
      deletedAccumulationFund(){
        let _this = this;
        let ids = _this.multipleSelection;
        if(ids.length != 0){
          _this.myConfirm("警告：公积金记录删除后将不能还原！","question-icon",'是','否',"确定要删除选定记录吗？").then(res => {
            _this.deletedIMSuccess();
          }).catch(err => {

          })
        }else{
          _this.myAlert("请选择要删除的公积金记录！")
        }
      },
      ...
      exportToExcel () {
        ...
        require.ensure([], () => {
          ...
          export_json_to_excel(tHeader, data, '公积金列表')
        })
      },
      ...
      changeTitle(count,needlayerid,upordown){
        ...
        getLayerId.getElementsByClassName('lv-title')[0].innerHTML = "公积金修改 【" + _this.tableData[mycountnum].user + '&nbsp;&nbsp;&nbsp;&nbsp;' + _this.tableData[mycountnum].time + "】";
