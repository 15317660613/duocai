          ...
          <div class="move-content" style="height:450px;padding:5px;" >
              <el-form ref="formsData"  :model="form" >
                <div class="clear padding-top-5" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="itemClassTwo" >
                            <el-select  v-model="form.itemClassTwo" @change="getItemClassThreeByTwoId"  placeholder="" style="width:97px;" >
                    ...
                    <div v-if="isShow == 1" class="left padding-r-1" >
                        <el-form-item  prop="itemClassThree"  >
                            <el-select v-model="form.itemClassThree" @change="getItemClassFourByThreeId"   placeholder="" style="width:162px;" >
                    ...
                    <div v-if="isShow == 1" class="left padding-r-1" >
                        <el-form-item  prop="itemClassFour" >
                            <el-select  v-model="form.itemClassFour"  @change="accountMangage"  placeholder="" style="width:152px;" >
                                <el-option  v-for="item in itemClassFourParams" :label="item.name + (item.remark ? item.remark : '')" :value="item.id" ></el-option>
                            </el-select>
                        </el-form-item>
                    </div>
                </div>
                <div v-if="showAccountIcon == 1" class="clear"  >
                    <div class="left  padding-r-2" style="width:75px;text-align:right;padding-top:4px;" >
                        <i @click="accountMangageClick"  class="account-icon" ></i>
                    </div>
                    <div class="left padding-r-1" style="padding-top:5px;" >
                ...
                <div class="clear padding-top-5" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="event" >
                            <el-input title="上限30个字" maxlength="30"  v-model="form.event"   placeholder="" style="width:413px;"  ></el-input>
                ...
                <div class="clear padding-top-5" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="price" >
                            <el-input @input="checkNumPrice" title="上限10位数" maxlength="13"  v-model="form.price"   placeholder="" style="width:100px;"  ></el-input>
                    
                        </el-form-item>
                    </div>
                    <div class="left padding-r-1" >
                        <el-form-item  prop="wayOne" >
                            <el-select v-model="form.wayOne"   placeholder="" style="width:80px;" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="wayTwo" >
                            <el-select v-model="form.wayTwo"   placeholder="" style="width:80px;" >
                    ...
                    <div class="left padding-r-1" v-if="manageShow == 0" >
                        <div @mouseleave="showSelect1 = false" class="el-select" style="width:150px;padding-top:4px;position:relative;" >
                            <div class="el-input el-input--suffix" >
                                <input title="此处填写该金额的存出方式，且存出方式各金额相加必须等于金额总数！" @click="showSelectInputClick1" type="text" readonly="readonly" v-model="boxType1" autocomplete="off" placeholder class="el-input__inner">
                            ...
                            <div class="" v-show="showSelect1" style="position:absolute;width:100%;background:#fff;z-index:10;padding-left:5px;" >
                                <div class="clear"  v-for="(item ,index) in storageParams" >
                                    ...
                                    <span class="left select-check" >
                                        <input type="text" maxlength="10"  @input="changeBoxType1(item)" v-model="item.money" style="width:50px;border-bottom:1px solid #999;" >
                                    </span>
                ...
                <div class="clear padding-top-5" v-if="manageShow == 1" >
                    ...
                    <div class="left padding-r-1"  >
                        <div  @mouseleave="showSelect2 = false"  class="el-select" style="width:150px;padding-top:4px;position:relative;" >
                            <div class="el-input el-input--suffix" >
                                <input title="此处填写该金额的存出方式，且存出方式各金额相加必须等于金额总数！" @click="showSelectInputClick2" type="text" readonly="readonly" v-model="boxType2" autocomplete="off" placeholder class="el-input__inner">
                                <span class="el-input__suffix" >
                                <span class="el-input__suffix-inner" ></span>
                                </span>
                            ...
                            <div class="" v-show="showSelect2" style="position:absolute;width:100%;background:#fff;z-index:10;padding-left:5px;" >
                                <div class="clear"  v-for="(item ,index) in storageParams2" >
                                    ...
                                    <span class="left select-check" style="margin-left:-12px;" >{{item.name}}</span>
                                    <span class="left select-check" >
                                        <input type="text" maxlength="10" @input="changeBoxType2(item)" v-model="item.money" style="width:50px;border-bottom:1px solid #999;" >
                                    </span>
                                    <span class="left select-check" style="margin-left:0px;" >元</span>
                                </div>      
                            </div>
                    ...
                    <div class="left padding-r-1"  >
                        <div  @mouseleave="showSelect3 = false"  class="el-select" style="width:150px;padding-top:4px;position:relative;" >
                            <div class="el-input el-input--suffix" >
                                <input  @click="showSelectInputClick3" type="text" readonly="readonly" v-model="boxType3" autocomplete="off" placeholder class="el-input__inner">
                                <span class="el-input__suffix" >
                                <span class="el-input__suffix-inner" ></span>
                                </span>
                            ...
                            <div class="" v-show="showSelect3" style="position:absolute;width:100%;background:#fff;z-index:10;padding-left:5px;" >
                                <div class="clear"  v-for="(item ,index) in storageParams3" >
                                    <span class="left" >
                                        <el-checkbox title="此处填写该金额的存出方式，且存出方式各金额相加必须等于金额总数！" @change="changeBoxType3(item)" v-model="item.select" :false-label="0" :true-label="1" >&nbsp;</el-checkbox>
                                    </span>
                ...
                <div class="clear padding-top-5" v-if="manageShow == 0" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="expenditureIdType" >
                            <el-select @change="changeExpenditureIdType" v-model="form.expenditureIdType" 
                    ...
                    <div v-if="form.expenditureIdType == '1'" class='left clear' >
                        <div class="left padding-r-1" >
                            <el-form-item  prop="expenditureCoop" >
                                <el-select v-model="form.expenditureCoop"  @change="finUserByDepart1"    placeholder="" style="width:135px;" >
                                    <el-option  v-for="item in departParams1" :label="item.name" :value="item.id" ></el-option>
                                </el-select>
                            </el-form-item>
                        </div>
                        <div class="left padding-r-1" >
                            <el-form-item  prop="expenditureId" >
                                <el-select v-model="form.expenditureId"   placeholder=""  style="width:100px;" >
                    ...
                    <div v-if="form.expenditureIdType == '2'" class='left clear' >
                        <div class="left padding-r-1" >
                            <el-form-item  prop="expenditureCoop" >
                                <el-select v-model="form.expenditureCoop"    placeholder="" style="width:100px;" >
                        ...
                        <div class="left padding-r-1" >
                            <el-form-item  prop="expenditureId" >
                                <el-input title="上限30个字" maxlength="30"   v-model="form.expenditureId"   placeholder="" style="width:210px;"  ></el-input>
                            </el-form-item>
                        </div>
                    </div>   
                    <div v-if="form.expenditureIdType == '3'" class='left clear' >
                        ...
                        <div class="left padding-r-1" >
                            <el-form-item  prop="expenditureId" >
                                <el-input  title="上限30个字" maxlength="30"  v-model="form.expenditureId"   placeholder="" style="width:311px;"  ></el-input>
                            </el-form-item>
                        </div>
                    </div>       
                ...
                <div class="clear padding-top-5" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  label-width="0">
                            <el-date-picker size="mini"  value-format="yyyy-MM-dd" type="date" placeholder="选择日期" v-model="form.time" style="width: 100px;" ></el-date-picker>
                        </el-form-item>
                    </div>     
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="financeUserDepartId" >
                            <el-select v-model="form.financeUserDepartId" @change="finUserByDepart2"  placeholder="" style="width:100px;" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="financeUserId" >
                            <el-select v-model="form.financeUserId"   placeholder="" style="width:100px;" >
                ...
                <div class="clear padding-top-5" >
                    ...
                    <textarea class="remark" style="width:412px;height:60px;" v-model="form.remark" title="上限100个字" maxlength="100" ></textarea>
                    </div>  
                </div>
                 <div v-if="synchorShow == 1" class="clear " >
                    ...
                    <div class="clear padding-top-5" >
                        ...
                        <div class="left" style="padding-top:2px;"  >
                            <el-checkbox v-model="form.isSyncConsumables" :false-label="0" :true-label="1" >&nbsp;</el-checkbox>
                        </div>
                        ...
                        <div class="left padding-r-1" >
                            <el-form-item  prop="consumablesId" >
                                <el-select v-model="form.consumablesId"   placeholder="" style="width:100px;" >
                 ...
                 <div v-if="synchorShow == 1" class="clear">
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="consumablesId" >
                            <el-select  @change="consumablesIdfunc" v-model="form.physicalCoopStateId" style="width:100px;" >
                    ...
                    <div class="left padding-r-1" >
                        <el-form-item  prop="consumablesId" >
                            <el-select v-model="form.physicalCoopId"   placeholder="" style="width:100px;" >
...
<script>
  ...
  import {getfinanceParams,addFinanceData} from "../../../service/financeData"; 
  ...
  export default {
    ...
    data() {
      return {
        ...
        showSelect3:false,
        boxType3:'',
        expenditureDisabled:false, //平账禁用收支对方
    ...
    methods:{
       ...
       getFinanceParamData(){
        ...
        getfinanceParams(form).then(function(response) {
          if (response.status == 500) {
            ...
            _this.itemClassFourParams = [{id:'',name:" ",select:true}];
            let storageParams = data.storageParams;
            ...
            let wayOneParams = data.wayOneParams;
            _this.wayOneParams = [{id:'',name:" ",select:true}].concat(wayOneParams);
            let wayTwoParams = data.wayTwoParams;
            ...
            _this.consumeManages = [{id:'',name:" ",select:true,isClosed:0}].concat(data.consumeManages);
            _this.departCoopStateParams = [{id:'',name:" ",select:true,isClosed:0,}].concat(data.departCoopStateParams);
          } else if (response.status == 1) {
      ...
      saveData(){
        ...
        let accountPrice = this.accountPrice;
          ...
          return false;
            ...
            if(itemClassName != '' && itemClassName != '管理' && itemClassFour == ''){
                ...
                if(threeName.indexOf('X') != -1 && fourName.indexOf("5") != -1){
                    ...
                    if(expenditureId != fexpenditureId){
        ...
        if(itemClassName != '' && itemClassName != '管理'){
            if((threeName.indexOf('X') != -1 && fourName.indexOf("5")  != -1)|| ( threeName.indexOf('X') != -1 && fourName.indexOf("4") != -1) || 
                ...
                if(accountPrice != "" && ( price*1 >  accountPrice*1)){
        ...
        if(form.isSyncPhysical=='1'&&form.consumablesId==''){
        ...
        addFinanceData(form).then(function(response){

          if (response.status == 500) {
            return false;
          } else if (response.status == 0) {
              _this.myAlert("数据保存成功",'success-icon').then(res => {
                _this.$parent.searchFinanceDataList();  
                _this.cancelData();
              }).catch(err => {
