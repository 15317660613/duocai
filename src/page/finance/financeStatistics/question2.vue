  ...
  <div class="" style="width:100%;padding:0 10px;" >
      <div class="pop-up" >
        <div class="pop-up-container clear" style="margin-bottom:10px;" >
          <div class="left list-container list-content" style="height:462px;width:100%;" >
                    ...
                    >
                      <template slot-scope="scope">
                        <div  style="padding-left:5px;position:relative;" >
                          <span style="padding-right:20px;" >{{scope.row.price2}}</span>
...
<script>
  ...
  import{getFinanceExpendQuestion5}  from "../../../service/financeStatistics";
  export default {
    props:["layerid",'type'],
    data() {
      return {
    ...
    methods:{
      ...
      getDataList(){
        ...
        getFinanceExpendQuestion5(form).then(function (response) {
