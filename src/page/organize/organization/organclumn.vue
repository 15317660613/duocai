<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="自选列" width="350px" @close="clearFormData" :visible.sync="orColumn" >
      <div class="pop-up" >
        <div class="pop-up-container " style="height: 346px;">
          <div class="move-content list-content clear" >
            ...
            <div class="right right-column" >
              ...
              <div class="item-earch-btn"  @click="orColumn = false" >
                取消
              </div>
            </div>
          </div>
  ...
  export default {
    ...
    methods:{
      ...
      setListData() {
        ...
        let columnData =orgnizetionParam.orColumn;
        if (titleData != null) {
      ...
      saveData() {
        ...
        storage.setItem("organ-list", columnData);
