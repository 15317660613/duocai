  ...
  <div class="depart-container mycontailerclass1">
    <div class="top-container " >
      <div class="search-container mycontailerclass2 clear" >
        <div class="item left"  >
          <el-radio   @change="duixian(1)" v-model="nowstate" :label="1">&nbsp;</el-radio>
          <span>现状</span>
        </div>
        <div class="item left"  >
          <el-radio   @change="duixian(2)" v-model="nowstate" :label="2">&nbsp;</el-radio>
          <span>周比</span>
        </div>
        <div class="item left"  >
          <el-radio   @change="duixian(3)" v-model="nowstate" :label="3">&nbsp;</el-radio>
          <span>月比</span>
        </div>
        <div class="item left"  >
          <el-radio   @change="duixian(4)" v-model="nowstate" :label="4">&nbsp;</el-radio>
          <span>季比</span>
        </div>
        <div class="item left"  >
          <el-radio  @change="duixian(5)" v-model="nowstate" :label="5">&nbsp;</el-radio>
          <span>年比</span>
        </div>
          ...
          <div class="clear" >
            ...
            <div class="left p-l-2" >
              <el-form-item  label-width="0">
                <el-select class="left" v-model="angle" style="width: 80px;" @change="dedu">
