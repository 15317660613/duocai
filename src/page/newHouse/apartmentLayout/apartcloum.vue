<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="自选列" width="350px" @close="clearFormData" :visible.sync="apColumn" >
      <div class="pop-up" >
        <div class="pop-up-container " style="height:336px;margin: 10px;">
          <div class="move-content list-content clear" >
            ...
            <div class="right right-column" >
              ...
              <div class="item-earch-btn" style="margin-top:12px;" @click="saveData" >
                保存
              </div>
              <div class="item-earch-btn"  @click="apColumn = false" >
                取消
              </div>
            </div>
          </div>
    ...
    methods:{
         showcluon(){
          ...
          setListData() {
            ...
            let titleData = storage.getItem("organ-list");
            let columnData =apartParamnes.apaColumn;
            if (titleData != null) {
          ...
          initSort(){
            debugger;
            let columnData = JSON.parse(JSON.stringify(this.columnDataList));
          ...
          saveData() {
            ...
            storage.setItem("apart-list", columnData);
