<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="新增房号" width="500px" :visible.sync="dialogNewHouseNum" @close="clearFormData" :append-to-body="true" >
      <div class="pop-up" >
              ...
              <div class="clear" >
                ...
                <div class="left" >
                  <el-form-item prop="typeId" >
                    <el-select v-model="form.typeId" placeholder=""      style="width:75px;" >
...
<script>
  import {addHouseNum,editorHouseNum}  from '../../../service/newHouse'
  export default {
    ...
    methods:{
      ...
      saveFormData(){
        ...
        addHouseNum(form).then(function(response){
          if(response.status == 500){
            return false;
          }else if(response.status == 0){
