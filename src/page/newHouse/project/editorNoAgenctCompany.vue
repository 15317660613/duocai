<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag :title="'【无平台-'+platformName+'】详情'" width="600px" height="400px" @close="clearFormData" :visible.sync="dialogVisible" :append-to-body='true' >
                ...
                <div class="clear" >
                  ...
                  <div class="left">
                    <el-form-item  prop="commModeId" >
                      <el-select v-model="form.commModeId"    style=" width:80px;" >
                  ...
                  <div class="clear" >
                    ...
                    <div class="left" >
                       <el-form-item  prop="startTime" >
                        <el-date-picker :disabled="haveRecordNum" type="datetime" style="width:152px;"  v-model="form.startTime" value-format="yyyy-MM-dd HH:mm" ></el-date-picker>
                      </el-form-item>
                    </div>
