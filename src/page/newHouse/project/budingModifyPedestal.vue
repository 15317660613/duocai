<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag :title="'批量修改房源栋座 【'+titlename+'】'" width="400px" @close="clearFormData" :visible.sync="dialogBuildingModifyPedestal" :append-to-body="true" >
      <div class="pop-up" >
