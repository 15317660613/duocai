<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag :title="'批量生成栋座 【'+title+'】'" width="600px" height="250px" :visible.sync="dialogBatchPedestal" @close="clearFormData" :append-to-body="true" >
      ...
      <div class="pop-up" >
        <el-form ref="formsData" :model="form">
          ...
          <div class="pop-up-container " style="height: 249px;">
          <div class="clear" >
...
<script>
  import {editorPedestal,batchAddPedestal} from '../../../service/newHouse'
  ...
  export default {
    ...
    methods:{
      ...
      saveData(){
        ...
        batchAddPedestal(form).then(function(response){
          if(response.status == 500){
            return false;
          }else if(response.status == 0){
