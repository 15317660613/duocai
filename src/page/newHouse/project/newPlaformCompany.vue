<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="新增平台公司" width="550px" @close="clearFormData" :visible.sync="dialogVisible" :append-to-body='true' >
      <div class="pop-up" >
...
<script>
  ...
  import {addPlaformCompany} from '../../../service/newHouse'
  export default {
    props:["newPlatformCompanyVisible"],
    data() {
      return {
        dialogVisible:this.newPlatformCompanyVisible,
        checkHouse:false,
        processWayIdParams:[],
        departTree:[],
        userList:[],
    ...
    methods:{
      ...
      saveData(){
        ...
        addPlaformCompany(form).then(function(response){
