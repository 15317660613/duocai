<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="新增无平台" width="600px" height="250px" @close="clearFormData" :visible.sync="dialogVisible" :append-to-body='true' >
      <div class="pop-up" >
                ...
                <div class="clear" >
                  ...
                  <div class="left">
                    <el-form-item  prop="contactor" >
                      <el-input   v-model="form.contactor" title="上限10个字" maxlength="10" style="width:100px;" ></el-input>
                    </el-form-item>
                  </div>
                  <div class="left padding-r-2" style="width:70px;text-align:right;" >
                    <span class="word require-word" >报备电话</span>
                  </div>
                  <div class="left">
                    <el-form-item  prop="contactorPhone" >
                      <el-input @input="checkPhone"   v-model="form.contactorPhone" title="上限15位数" maxlength="15" style="width:100px;" ></el-input>
                    </el-form-item>
                  </div>
                ...
                <div class="clear" >
                  ...
                  <div class="left">
                    <el-form-item  prop="commCount" >
                      <el-input   v-model="form.commCount" title="上限10个字" maxlength="13" style="width:80px;" ></el-input>
                    </el-form-item>
                  </div>
                  <div class="left" >
                  ...
                  <div class="clear" >
                    ...
                    <div class="left" >
                      <el-form-item  prop="startTime" >
                        <el-date-picker type="datetime" style="width:152px;"  v-model="form.startTime" value-format="yyyy-MM-dd HH:mm" ></el-date-picker>
                      </el-form-item>
                    </div>
  ...
  export default {
    ...
    methods:{
      ...
      saveData(){
        ...
        let contactor = form.contactor;
        let contactorPhone = form.contactorPhone;
        if (contactor == "") {
          this.myAlert("报备联系人不能为空！", 'dangerous-icon');
          return false;
        }
        if (contactorPhone == "") {
          this.myAlert("报备电话不能为空！", 'dangerous-icon');
          return false;
        }
        ...
        if (!commTypeId  || !commTypeRemark) {
          this.myAlert("佣金类型不能为空！", 'dangerous-icon');
          return false;
        }
        if (!commModeId || commCount == '') {
          this.myAlert("佣金模式不能为空！", 'dangerous-icon');
          return false;
        }
        if(!startTime){
          this.myAlert("启用时间不能不能为空！", 'dangerous-icon');
          return false;
        }
