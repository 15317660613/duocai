<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag :title="'修改销售公司 【'+saleCompany+'】'" width="550px" @close="clearFormData" :visible.sync="dialogVisible" :append-to-body='true' >
            ...
            <el-form ref="formsData" :model="form">
              <div class="" style="padding:0px;" >
                <div class="clear" >
                  ...
                  <div class="left">
                    <el-form-item  prop="contactCompany" >
                      <el-input  v-model="form.contactCompany" title="上限50个字" maxlength="50" style="width:390px;" ></el-input>
                    </el-form-item>
                  </div>
                ...
                <div class="clear" >
                  ...
                  <div class="left padding-r-3" style="width:100px;text-align:right;">
                ...
                <div class="clear" >
                  ...
                  <div class="left">
                    <el-form-item  prop="remark" >
                      <el-input  v-model="form.remark" title="上限50个字" maxlength="50" style="width:390px;" ></el-input>
                    </el-form-item>
                  </div>
                </div>
                <div v-if="item.deleted == 0" class="clear" v-for="(item , index) in connectionList" >
                  ...
                  <div class="left padding-r-3" style="padding-left:50px;" >
...
<script>
  ...
  import {editorSaleCompany,modifySaleCompany} from '../../../service/newHouse'
  export default {
    props:["editorSaleCompanyVisible"],
    data() {
      return {
        dialogVisible:this.editorSaleCompanyVisible,
        checkHouse:false,
        processWayIdParams:[],
        departTree:[],
        userList:[],
    ...
    methods:{
      ...
      showDialog(id,projectId,saleCompany){
      ...
      getSaleCompany(){
        ...
        editorSaleCompany(id).then(function(response){
          _this.$layer.closeAll("loading");
          if (response.status == 500) {
            return false;
          } else if (response.status == 0) {
            let form = response.data.houseDelegateC;
            for(let arr in form ){
              if(form[arr] == null){
                form[arr] = "";
              }
      ...
      saveData(){
        ...
        modifySaleCompany(form).then(function(response){
          _this.$layer.closeAll("loading");
          if (response.status == 500) {
            return false;
          } else if (response.status == 0) {
