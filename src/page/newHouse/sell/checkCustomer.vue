              ...
              <div class="clear" >
                ...
                <div class="left" style="padding-left:35px;" >
                  <el-form-item  prop="word4" >
                    <el-input v-model="form.word4" title="客源编号/客户名称"   style="width:120px;" ></el-input>
                  </el-form-item>
                </div>
...
<script>
  ...
  export default {
    props:["checkHouseValue",'layerid','customerIdParent','projectId'],
    data() {
      return {
    ...
    methods:{
      ...
      saveFormData(){
        ...
        if(check == '' ){
          ...
          this.$parent.setCheckCustomerData(check,elem);
          this.cancelData();
        }
      },
