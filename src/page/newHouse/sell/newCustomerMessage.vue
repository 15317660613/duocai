<template>
  <div class="" >
    <el-dialog :close-on-click-modal="false" v-dialogDrag title="客户信息" width="550px" @close="clearFormData" :visible.sync="dialogVisible" :append-to-body='true' >
      <div class="pop-up" >
...
<script>
  ...
  import {addPrebuyEmp} from '../../../service/salesControl'
  export default {
    props:["newCustomerMessageVisible"],
    data() {
      return {
        dialogVisible:this.newCustomerMessageVisible,
        apartmentSelect:[],
    ...
    methods:{
      ...
      saveData(){
        ...
        addPrebuyEmp(form).then(function(response){
